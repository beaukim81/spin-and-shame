        ...
        <div className="w-full max-w-2xl bg-[#121A2F] rounded-[32px] p-[clamp(16px,4vw,40px)] shadow-2xl border border-purple-500/20">
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            ...
            <button
              ...
              className={`rounded-2xl p-4 font-black border transition-all ${selectedMode === "genz"
            ...
            <button
              ...
              className={`rounded-2xl p-4 font-black border transition-all ${selectedMode === "popculture"
